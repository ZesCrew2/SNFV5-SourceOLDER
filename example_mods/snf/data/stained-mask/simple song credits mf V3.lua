composer = "waranex" -- This goes for each song, you have to adjust the names.
...
va = "Dream, yungtron" -- This goes for each song, you have to adjust the names.
-- bpm = "BPM Here" -- Please make sure to change the bpms for each song, because I don't know how to get the chart bpms correctly. (way before Herox figured it out as I don't need that one)
---------------------------------------------------------------------------------------------
