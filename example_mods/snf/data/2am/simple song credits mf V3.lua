...
artist = "Syn & ZesCrew2" -- This goes for each song, you have to adjust the names.
animator = "Syn & ZesCrew2" -- This goes for each song, you have to adjust the names.
va = "Syn & ZesCrew2" -- This goes for each song, you have to adjust the names.
